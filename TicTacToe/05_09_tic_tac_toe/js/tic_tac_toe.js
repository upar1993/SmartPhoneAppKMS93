...
// メッセージ
const msgtxt1 = '<p class="image"><img src ="img/cindrella1.jpeg" width=61px height=61px></p><p class="text">Cindrella Attack!(your turn)</p>';
const msgtxt2 = '<p class="image"><img src ="img/snowwhite1.jpeg" width=61px height=61px></p><p class="text">Snow White Attack!(computer turn)</p>';
const msgtxt3 = '<p class="image"><img src ="img/cindrella1.jpeg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInRight">Cindrella Win!!</p>';
const msgtxt4 = '<p class="image"><img src ="img/snowwhite1.jpeg" width=61px height=61px></p><p class="text animate__animated animate__lightSpeedInLeft">Snow White Win!!</p>';
const msgtxt5 = '<p class="image"><img src ="img/cindrella.jpeg" width=61px height=61px><img src ="img/snowwhite.jpeg" width=61px height=61px></p><p class="text animate__bounceIn">Draw!!</p>';
...
window.addEventListener("DOMContentLoaded",
    function(){
        ...
        LevelSetting(0); //levelの要素取得 レベル1設定
...
function bearTurn(){
    ...
    while(bearTurnEnd === "0"){
        ...
        if(level === "3"){
            //角のマス目a_1, a_3, c_1, c_3 が空いていたら選ぶ
        ...
        //まだマス目を選んでいた場合、クリックできるマス目をランダムに選ぶ
